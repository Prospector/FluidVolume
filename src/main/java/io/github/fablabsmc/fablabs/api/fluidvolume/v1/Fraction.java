...
public final class Fraction extends Number implements Comparable<Fraction>, DynamicSerializable {
    ...
    public JsonObject toJson() {
        ...
        json.addProperty("numerator", numerator);
        json.addProperty("denominator", denominator);
        return json;
    }

    public static Fraction fromJson(JsonObject json) {
        return of(json.get("numerator").getAsInt(), json.get("denominator").getAsInt());
    }
    ...
    public static Fraction fromPacket(PacketByteBuf buf) {
        return of(buf.readInt(), buf.readInt());
    }
